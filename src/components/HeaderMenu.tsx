    ...
    <header className="sticky top-0 z-50 bg-paper">
      ...
      <div className="relative flex h-9 items-center border-y-3 border-line bg-paper px-4 max-[767px]:h-[44px] max-[767px]:px-3">
        ...
        <div className="z-10 ml-auto flex items-center gap-3 font-display font-black max-[767px]:gap-0.5">
          <CartIcon />
          <ProfileIcon />
          <button className="rounded-md border-3 border-line bg-navy px-3 py-1 text-sm leading-none text-paper shadow-sketch max-[767px]:border-0 max-[767px]:bg-transparent max-[767px]:p-0 max-[767px]:shadow-none">
...
function ProfileIcon() {
  return (
    <span className="grid h-8 w-8 place-items-center md:rounded-full md:border-3 md:border-line md:bg-navy" aria-label="Profile">
